...
class Product(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, verbose_name=_("Sahip"))
    ...
    min_bid_increment = models.DecimalField(max_digits=6, decimal_places=2, default=10.00, verbose_name=_("Minimum Artış Miktarı"))
